...
export default function App() {
  return (
    <div className="flex h-[100dvh] flex-col divide-y divide-teal-300 dark:divide-teal-300/10 dark:bg-teal-950 dark:caret-yellow-500">
      <header className="flex h-14 shrink-0 divide-x divide-teal-300 dark:divide-teal-300/10">
        <a
          className="flex aspect-square h-full items-center justify-center hover:bg-teal-800"
          href="/"
